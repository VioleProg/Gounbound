<div id="content">
	<div id="content_full">
		<div id="content_full_top">
			<h2>
				<img src="template/gbetools/images/title_cadastro.png" />			</h2>
		</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="586">
  ...
  <tr>
    <td background="template/jsplink/images/modules_r1_c1.gif">&nbsp;</td>
    <td><img src="images/spacer.gif" width="1" height="34" border="0" alt="" /></td>
  </tr>
  <tr>
    <td align="left" valign="top" background="template/jsplink/images/modules_r2_c1.gif"><?PHP
        ...
        <option value="1">Feminino</option>
                  ...
                  <td align="right"><table width="225" border="0">
                    <tr>
                      ...
                      <td width="112" align="right"><input class="textfield"  name="pass1" type="password" size="20" maxlength="10" style="border-style: solid; border-color: #E8E8E8; font-family: Arial; font-size: 10pt;  color: #2E2E2E; width: 110px; height: 16px; background-color:#FEFFF0;"/>                      </td>
                    </tr>
                    <tr>
                      <td height="40" align="right">Repetir Senha:</td>
                      <td align="right"><input class="textfield"  name="pass2" type="password" size="20" maxlength="10" style="border-style: solid; border-color: #E8E8E8; font-family: Arial; font-size: 10pt;  color: #2E2E2E; width: 110px; height: 16px; background-color:#FEFFF0;"/>                      </td>
                    </tr>
...
$reg_form .= '
              ...
              <table width="531" border="0" align="center">
                <tr>
                  <td width="222" valign="top"><table width="220" border="0">
                    <tr>
                  ...
                  <td width="299" align="right" valign="top"><table width="287" border="0">
                    <tr>
...
?>
      <a href="comprar_credito.html"></a><a href="addvip.html"></a></td>
