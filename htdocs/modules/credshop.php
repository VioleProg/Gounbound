...
elseif ($_POST['shopv2_credito'] == 0 or NULL) {	
$msg_avt = "<font color='red'>Este avatar não pode ser comprado com credito</font>"; 
}
elseif ($credito['Credito'] < $_POST['shopv2_credito']) {
$msg_avt = "<font color='red'>Seu credito é insuficiente.</font>";
                    ...
                    $rankmax = $rank[0]['No']; 
							...
							if ($db->Affected_Rows()== 1) {								 
								...
								$db->Execute("Update credito set Credito = Credito - ? where Id = ?", array($_POST['shopv2_credito'],$user_auth->username));
							...
							writelog("Login: ".$user['Id'] ." Comprou: ".$_POST['shopv2_nome']." - ".$_POST['shopv2_codigo'], 'CredShop'); 
						}
					}
			...
			echo "";
			if ($credito['Credito'] >= $_POST['shopv2_credito']) { 
				echo " ";
			} else {
