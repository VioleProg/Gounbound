...
// Fim do c&oacute;digo de avatares
			...
			echo "
				 ...
				 &laquo; Ao fazer a troca voc&ecirc; receber&aacute; um SET <br><strong>Alice e a bandeira Valentine Candy (RARO)</strong> <br>
				 &laquo; Possuo: <b>".$game['EventScore0']." </b>Pontos de Evento<br><br>";
			if ($game['EventScore0'] >= $config['evento_avatar']) { 
				echo "
				
				  <form method='post' action='ucwarrior_female-ponto-trocar.jsp'>
