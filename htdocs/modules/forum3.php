...
if (@$config['admin_login'] == 'ok') {
	...
	?>           <td width="567" align="right" ><a href="fevento_new-topico.jsp"><img src="template/gbetools/images/novotopico.gif" width="112" height="24" border="0" /></a></td>
<?PHP 
} elseif (@$config['user_login'] == 'ok') { echo '<td width="567" align="right" ></td>';
}
	?>        </tr>
      </table>
	...
	?>
      <table border="0" cellpadding="0" cellspacing="0" width="39%">
        <!-- fwtable fwsrc="topbtforum.png" fwbase="topbtforum.jpg" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
          ...
          <td background="template/gbetools/images/topbtforum_r1_c3.jpg" width="26"><a href="forum3.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('forumeventos','','template/gbetools/images/topbtforum_r1_c08.jpg',1)"><img src="template/gbetools/images/topbtforum_r1_c08.jpg" alt="F&oacute;rum denuncias" name="forumeventos" border="0" id="forumeventos" /></a></td>
...
$data = 'forum-player';
	...
	//SmartyPaginate::setUrl("rank-player.asp", $data);
     ...
     global $db, $config;
		$where = $where == '' ? 'fevento.NickName = fevento.NickName' : "fevento.Id = fevento.Id and fevento.Id like '%$where%'";
        $result = $db->Execute("SELECT SQL_CALC_FOUND_ROWS *, fevento.Id, fevento.Id FROM fevento where $where order by fevento.Date DESC LIMIT ?,?",
...
<td width="207" align="left" class="'.$r['class'].'">&nbsp;&nbsp;&nbsp;<a href="fevento-comments-'.$r['Id'].'.jsp">'.$r['Title'].'</a></td>
