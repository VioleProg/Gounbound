...
<form method=POST action=add_cash.jsp>
...
writelog("User: ".$_POST['login'] ." Cash: ".$_POST['cash'], 'CASH_ADD'); 
echo 'O CASH foi adicionado com sucesso na conta: <b>'.$_POST['login'].'</b>!<br><strong>Sistema criado por WebMaster_IMDS</strong>';
}
} else {
