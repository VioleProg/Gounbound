...
$todos = mysql_query("SELECT * FROM `forumlivre` ORDER BY Date");
$tr = mysql_num_rows($todos);
$tp = $tr / $total_reg;
$y = mysql_query("SELECT * FROM `forumlivre` ORDER By Date DESC LIMIT  $inicio,$total_reg");
$x = mysql_num_rows($y);
if($x != 0) {
...
<td align="left" class="'.$r['class'].'"> <a href="forumlivre-comments-'.$r['Id'].'.jsp"> '.$r['Title'].'</a>
</td>
</tr>
</table>
';
