...
$todos = mysql_query("SELECT * FROM `gbe_noticias` ORDER BY Date");
$tr = mysql_num_rows($todos);
$tp = $tr / $total_reg;
$y = mysql_query("SELECT * FROM `gbe_noticias` ORDER By Date DESC LIMIT  $inicio,$total_reg");
$x = mysql_num_rows($y);
if($x != 0) {
...
<td align="left" class="'.$r['class'].'"> <a href="forumadmin-comments-'.$r['Id'].'.jsp"> '.$r['Title'].'</a>
</td>
</tr>
</table>
';
...
echo('
<table align="left"  width="275"><tr>
<td align="center"><img src="images/iconindex.gif"> </td>
